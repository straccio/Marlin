...
//#define CODEPENDENT_XY_HOMING
  ...
  //Straccio 
  #define BLTOUCH_DELAY 200 //100 consigligiato teach eng.
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  20, Y_BED_SIZE/2 }, { 170,  Y_BED_SIZE/2 } }
  ...
  //#define Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS
    ...
    #define Z_STEPPER_ALIGN_AMP 1.0 // Use a value > 1. NOTE: This may cause instability
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     100
 ...
 */
  ...
  /**
   * Use  Guard2 to home / probe X, Y, Z.
   *
  ...
  #define SENSORLESS_HOMING
    ...
    //#define SPI_ENDSTOPS              // TM C2130 only
